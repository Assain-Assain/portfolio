...
export default function ProjectDetail() {
  ...
  return (
    <>
    <article className='pr_detail'  style={{
 ...
 <p>{t(project.solution)}</p> 
        ...
        <a href='https://rococo-sopapillas-8937da.netlify.app/'><p>{t(project.problem)}</p></a>
      </section>
      <section>
  ...
  {(t(project.highlightsKey, { returnObjects: true }) || []).map((h, i) => (
    <li key={i}>{h}</li>
      ...
      <div className="actions">
        {project.demo && <a className="btn primary" href={project.demo} target="_blank" rel="noreferrer">{t('projects.liveDemo')}</a>}
        {project.repo && <a className="btn secondary" href={project.repo} target="_blank" rel="noreferrer">{t("homecontact.github")}</a>}
